...
"
" Version: 1.80
"		   1.81 windows下去掉ctags 和 tglist的支持，配色方案设为evening
"=========================================================================
...
"-----------------------------------------------------------------
" plugin - ctags.vim 查看函数列表，需要ctags程序
"-----------------------------------------------------------------
...
let Tlist_Ctags_Cmd = '"'.$VIMRUNTIME.'/plugin/ctags.exe"'
elseif MySys() == "linux" " 设定linux系统中ctags程序的位置
let Tlist_Ctags_Cmd = '/home/zyh/.vim/plugin/ctags'
endif
